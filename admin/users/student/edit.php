...
<form method="post">
    ...
    <!-- Lớp (chỉ Student) -->
    <label class="student-field">Lớp:</label>
    <input type="text" name="class_name" value="<?= htmlspecialchars($user['class_name']) ?>" class="student-field">

    <!-- MSSV (Student + Teacher) -->
    <label class="mssv-field">Mã sinh viên:</label>
    <input type="text" name="student_code" value="<?= htmlspecialchars($user['student_code']) ?>" class="mssv-field">
    ...
    <a href="students.php" class="back-btn">🔙 Quay lại</a>
</form>
</main>
</div>
</body>
