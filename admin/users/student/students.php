...
<main class="main">
  ...
  <form method="post" action="bulk_delete.php" onsubmit="return confirm('Bạn có chắc muốn xóa sinh viên đã chọn?')">
    <a href="add_students.php" class="btn">➕ Thêm sinh viên</a>
    ...
    <table>
      ...
      <tr>
        ...
        <td>
          ...
          <a href="delete.php?id=<?= $u['id'] ?>" class="delete" onclick="return confirm('Xóa sinh viên này?')">🗑️ Xóa</a>
        </td>
      </tr>
      <?php endforeach; ?>
    </table><br>
