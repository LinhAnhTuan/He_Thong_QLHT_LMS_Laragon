...
<aside class="sidebar">
  <div class="sidebar-header">
    ...
    <nav class="menu">
        ...
        <a href="courses/list.php" class="menu-item <?= (strpos($currentPage, 'courses') !== false) ? 'active' : '' ?>">📚 Quản lý khóa học</a>
        <a href="quiz_teamplate/list.php" class="menu-item <?= (strpos($currentPage, 'quizz_teamplate') !== false) ? 'active' : '' ?>">📄 Mẫu Quiz </a>
        <a href="schedule/list.php" class="menu-item <?= (strpos($currentPage, 'schedule') !== false) ? 'active' : '' ?>">🗓️ Lịch học</a>
        <a href="settings/general.php" class="menu-item <?= (strpos($currentPage, 'settings') !== false) ? 'active' : '' ?>">⚙️ Cấu hình hệ thống</a>
